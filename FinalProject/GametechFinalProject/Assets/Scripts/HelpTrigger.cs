...
public class HelpTrigger : MonoBehaviour
{
    ...
    void InsertString(int index)
    {
        ...
        {
            case 1:
                hintLines[insertLine] = hintLines[insertLine].Insert(insertIndex, "<color=red>" + specialString + "</color>");
                break;
            case 2:
                hintLines[insertLine] = hintLines[insertLine].Insert(insertIndex, "<color=yellow>" + specialString + "</color>");
                break;
            default:
                hintLines[insertLine] = hintLines[insertLine].Insert(insertIndex, "<color=white>" + specialString + "</color>");
                break;
        }
    }
